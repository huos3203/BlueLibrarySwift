...
//    封面，加载进度条
    ...
    init(frame: CGRect,ablumCover:String) {
        ...
        commonInit()
        NotificationCenter.default.post(name: Notification.Name(rawValue: "BLDownloadImageNotification"), object: self, userInfo: ["coverImage":coverImage,"coverUrl":ablumCover])
    }
